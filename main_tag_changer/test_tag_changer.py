...
class TestClass:
    ...
    def test_find_feats(self, tag_changer):
        ...
        assert (tag_changer.find_feats('Artist (feat. Other1, Other2, Other3)')
                == ('Artist', ['Other1', 'Other2', 'Other3']))
        assert tag_changer.find_feats('Titleft ftOther (feat. Man)') == ('Titleft ftOther', ['Man'])
        assert tag_changer.find_feats('Titleft (ftOther) (feat. Dave)') == ('Titleft (ftOther)', ['Dave'])
